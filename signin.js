...
setchange(!change);
   ...
   function submithandler(e){
        ...
        let url;
        if(change){
url='https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAkFHYZdtSMmBNqIGbB3SVAe29p3M-Qi2g';
        }else{
            url='https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAkFHYZdtSMmBNqIGbB3SVAe29p3M-Qi2g';
        }
        fetch(url,{
            method:'POST',
            body:JSON.stringify({
...
.catch((err)=>{
    ...
    return(
        ...
        <h1 className="head">Welcome to Our Restaurant</h1>
        <br></br>
        <hr></hr>
        <div className="form">
